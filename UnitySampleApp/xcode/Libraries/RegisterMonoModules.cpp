...
extern "C"
{
    ...
    void	mono_dl_register_symbol (const char* name, void *addr);    
	void	_ASSetCallbackHandlerName();
	void	_CreatePopupAd();
	void	_Load();
	void	_PresentAd();
	void	_SetAdModes();
...
#endif // !(TARGET_IPHONE_SIMULATOR)
	mono_dl_register_symbol("_ASSetCallbackHandlerName", (void*)&_ASSetCallbackHandlerName);
	mono_dl_register_symbol("_CreatePopupAd", (void*)&_CreatePopupAd);
	mono_dl_register_symbol("_Load", (void*)&_Load);
	mono_dl_register_symbol("_PresentAd", (void*)&_PresentAd);
	mono_dl_register_symbol("_SetAdModes", (void*)&_SetAdModes);
	mono_dl_register_symbol("_EnableLocation", (void*)&_EnableLocation);
	mono_dl_register_symbol("_SetExtras", (void*)&_SetExtras);
}

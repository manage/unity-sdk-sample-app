...
public class ManagePluginAndroid {
	...
	public static void CreatePopupAd(string instanceId, string zoneId)
	{
		...
		AndroidJavaClass pluginFactoryClass = new AndroidJavaClass("com.manage.unity.ManagePluginFactory");
		...
		ManagePluginAndroid.RegisterInstance(instanceId, pluginInstance);
	}
	...
	{
		AndroidJavaObject pluginInstance = ManagePluginAndroid.ResolveInstance(instanceId);
